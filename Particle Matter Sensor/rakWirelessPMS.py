        ...
        try:
            ...
            if data:
                ...
                while(1):
                    ...
                    print(dataArray[1])
                    print(dataArray[2])
                    distanceString = "PMS~~TST~~" + str(dataArray[0]) + "~~" + str(dataArray[1]) + "~~" + str(dataArray[2]) #This acts as the payload for trasnmission and is in the structure: Sensor Type, Sensor Name, Value 1, Value 2, Value 3
                    ...
                    led.value(0)
                    time.sleep(15*60) #Stops the data from being constantly transmitted, by forcing it to wait for 15 minutes before iterating through the loop again
        except:
            time.sleep(5)
            joinNetwork()
