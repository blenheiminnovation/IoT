...
def findTemp(ADCValue):
    ...
    temperature = resistance / 10000 #Using the calculated, series and nominal values in the Steinhart equation to find the temperature in Kelvin
        ...
        try:
            ...
            if data:
                ...
                while(1):
                    ...
                    print(temperature)
                    temperatureString = ("TMP~~TST~~" + str(temperature) + "~~0~~0") #This acts as the payload for trasnmission and is in the structure: Sensor Type, Sensor Name, Value 1, Value 2, Value 3
