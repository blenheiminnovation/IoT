...
led = Pin(15, Pin.OUT)
xAxis = ADC(Pin(27)) #locates the X pin of the joystick and applies an analogue to digital converter to the value
yAxis = ADC(Pin(26)) #locates the Y pin of the joystick and applies an analogue to digital converter to the value
pwm = PWM(Pin(15))
...
while True:
    ...
    pwm.duty_u16(xValue) #Sets the brightness of the LED to the X value of the joystick
